    ...
    $('#cform').submit(function(){
                ...
                url:baseurl+'product-action',
                  ...
                  { 
                      ...
                      if(data.res == 1)
                       { 
                          success(data.msg);
                          setTimeout(function(){ window.location=baseurl+'product'; }, 700);
                       }
                       else
                    {
         ...
         $(document).on('click','.del-product',function(){
           ...
           alertify.confirm("Are you sure ?.",
             ...
             }).set({title:"Confirm delete product"}).set({labels:{ok:'Delete', cancel: 'Cancel'}});
        });
   ...
   $('#aform').submit(function(){
    ...
    var form_data = $("#aform").serializeArray();
       ...
       $.ajax({
          ...
          url:baseurl+'home-product-status',
            data:form_data,
